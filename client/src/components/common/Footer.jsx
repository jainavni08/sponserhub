  ...
  return (
    <footer className="mx-auto py-14 flex justify-center items-center">
        <div className="mx-auto">
          <ul className="text-lg flex items-center justify-center flex-col gap-8 md:flex-row md:gap-24 transition-all duration-500 py-16 mb-10 border-b border-gray-200">
            <Link
              to="/"
